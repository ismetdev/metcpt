...
function metcpt_ajax_seed_dummy_errors() {
    ...
    $dummy_errors = array(
        ...
        array( 'level' => 'error',     'message' => 'Call to undefined function metcpt_get_tender_meta()',        'source' => 'templates/tenders/single.php',            'file' => METCPT_PATH . 'templates/tenders/single.php',            'function' => 'metcpt_render_tender_single()',   'line' => 112, 'resolved' => 0, 'created_at' => date( 'Y-m-d H:i:s', strtotime( '-6 days' ) ) ),
        ...
        array( 'level' => 'notice',    'message' => 'Undefined variable: event_cal_url',                          'source' => 'templates/events/single.php',             'file' => METCPT_PATH . 'templates/events/single.php',             'function' => 'metcpt_render_event_single()',    'line' => 203, 'resolved' => 1, 'created_at' => date( 'Y-m-d H:i:s', strtotime( '-5 days' ) ) ),
        ...
        array( 'level' => 'notice',    'message' => 'Trying to get property of non-object',                       'source' => 'templates/careers/single.php',            'file' => METCPT_PATH . 'templates/careers/single.php',            'function' => 'metcpt_render_career_single()',   'line' => 145, 'resolved' => 1, 'created_at' => date( 'Y-m-d H:i:s', strtotime( '-1 day' ) ) ),
